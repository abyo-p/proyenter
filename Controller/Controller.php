...
/**
 * Class from which all controllers must inherit.
 *
 */
class Controller
{
    ...
    public function privateCore(&$response, $user, $permissions)
    {
        ...
        if ($defaultPage === 'TRUE') {
            ...
            $this->response->headers->setCookie(new Cookie('pyHomepage', $this->user->homepage, time() + \PYEN_COOKIES_EXPIRE));
            $this->user->save();
